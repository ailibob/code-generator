...
public class Po extends AnalysisFtl {
    @Override
    ...
    public String getTemplatePath() {
        return TemplatePathDict.PO;
    }

    @Override
    public String getOutputPath() {
        return OutputPathDict.PO.replace("%PlaceHolder%", CommandContext.getCommandContext().getClassName());
    }
}
