...
public class PagingRequest extends AnalysisFtl {
    @Override
    ...
    public String getTemplatePath() {
        return TemplatePathDict.PAGING_REQ;
    }

    @Override
    public String getOutputPath() {
        return OutputPathDict.PAGING_REQ.replace("%PlaceHolder%", CommandContext.getCommandContext().getClassName());
    }
}
