...
public class QueryResponse extends AnalysisFtl {
    @Override
    ...
    public String getTemplatePath() {
        return TemplatePathDict.QUERY_RES;
    }

    @Override
    public String getOutputPath() {
        return OutputPathDict.QUERY_RES.replace("%PlaceHolder%", CommandContext.getCommandContext().getClassName());
    }
}
