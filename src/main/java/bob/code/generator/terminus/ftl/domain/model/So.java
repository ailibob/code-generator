...
public class So extends AnalysisFtl {
    @Override
    ...
    public String getTemplatePath() {
        return TemplatePathDict.SO;
    }

    @Override
    public String getOutputPath() {
        return OutputPathDict.SO.replace("%PlaceHolder%", CommandContext.getCommandContext().getClassName());
    }
}
