...
public class WriteRequest extends AnalysisFtl {
    @Override
    ...
    public String getTemplatePath() {
        return TemplatePathDict.WRITE_REQ;
    }

    @Override
    public String getOutputPath() {
        return OutputPathDict.Create_REQ.replace("%PlaceHolder%", CommandContext.getCommandContext().getClassName());
    }
}
