...
public class ReadFacade extends AnalysisFtl {
    @Override
    ...
    public String getTemplatePath() {
        return TemplatePathDict.READ_FACADE;
    }

    @Override
    public String getOutputPath() {
        return OutputPathDict.READ_FACADE.replace("%PlaceHolder%", CommandContext.getCommandContext().getClassName());
    }
}
