...
public class UpdateRequest extends AnalysisFtl {
    @Override
    ...
    public String getTemplatePath() {
        return TemplatePathDict.UPDATE_REQ;
    }

    @Override
    public String getOutputPath() {
        return OutputPathDict.UPDATE_REQ.replace("%PlaceHolder%", CommandContext.getCommandContext().getClassName());
    }
}
