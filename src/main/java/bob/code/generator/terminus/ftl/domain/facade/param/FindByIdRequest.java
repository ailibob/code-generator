...
public class FindByIdRequest extends AnalysisFtl {
    @Override
    ...
    public String getTemplatePath() {
        return TemplatePathDict.FIND_ID_REQ;
    }

    @Override
    public String getOutputPath() {
        return OutputPathDict.FIND_ID_REQ.replace("%PlaceHolder%", CommandContext.getCommandContext().getClassName());
    }
}
