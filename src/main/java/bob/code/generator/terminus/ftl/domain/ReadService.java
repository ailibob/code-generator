...
public class ReadService extends AnalysisFtl {
    @Override
    ...
    public String getTemplatePath() {
        return TemplatePathDict.READ_SERVICE;
    }

    @Override
    public String getOutputPath() {
        return OutputPathDict.READ_SERVICE.replace("%PlaceHolder%", CommandContext.getCommandContext().getClassName());
    }
}
